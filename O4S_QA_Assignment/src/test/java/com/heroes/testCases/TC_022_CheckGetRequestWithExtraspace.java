...
import org.testng.Assert;
	...
	public class TC_022_CheckGetRequestWithExtraspace  extends TestBase{
		
		 			
				@BeforeClass
				void CheckGetWithSpace() throws InterruptedException
				{
					logger.info("*********Started TC_022_CheckGetRequestWithExtraspace **********");
			...
			void checkResposeBody()
				...
				void tearDown()
				{
					logger.info("********* Finished TC_022_CheckGetRequestWithExtraspace **********");
				}
