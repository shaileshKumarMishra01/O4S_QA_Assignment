...
public class TC_016_CheckAddingThreeHeroesInRandomPowerLevel   extends TestBase {


@BeforeClass
	void CheckAddRandom() throws InterruptedException
	    	{
			logger.info("*********Started TC_016_CheckAddingThreeHeroesInRandomPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_016_CheckAddingThreeHeroesInRandomPowerLevel **********");
		}
