...
public class TC_017_CheckAddingFourHeroes   extends TestBase {


@BeforeClass
	void CheckAddFourHero() throws InterruptedException
	    	{
			logger.info("*********Started TC_017_CheckAddingFourHeroes **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_017_CheckAddingFourHeroes **********");
		}
