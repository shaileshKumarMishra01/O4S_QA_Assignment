...
public class TC_011_CheckAddingTwoHeroInASCPowerLevel  extends TestBase {


@BeforeClass
	void CheckTwoHero() throws InterruptedException
	    	{
			logger.info("*********Started TC_011_CheckAddingTwoHeroInASCPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_011_CheckAddingTwoHeroInASCPowerLevel **********");
		}
