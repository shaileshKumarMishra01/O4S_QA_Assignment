...
public class TC_009_CheckAddingThreeHeroes extends TestBase {


@BeforeClass
	void CheckAddThreeHeroes() throws InterruptedException
	    	{
			logger.info("*********Started TC_009_CheckAddingSameHeroTwice **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_009_CheckAddingSameHeroTwice **********");
		}
}
