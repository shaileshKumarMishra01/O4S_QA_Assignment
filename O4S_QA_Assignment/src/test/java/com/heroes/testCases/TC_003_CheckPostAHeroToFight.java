...
public class TC_003_CheckPostAHeroToFight extends TestBase {
	
  	
	
	
	@BeforeClass
	void CheckPostHero() throws InterruptedException
	{
		logger.info("*********Started TC_003_PostAHeroToFight **********");
	...
	void tearDown()
	{
		logger.info("********* Finished TC_003_PostAHeroToFight **********");
	}
