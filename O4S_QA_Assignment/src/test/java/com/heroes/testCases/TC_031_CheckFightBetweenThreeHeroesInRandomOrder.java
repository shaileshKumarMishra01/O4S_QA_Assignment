...
public class TC_031_CheckFightBetweenThreeHeroesInRandomOrder     extends TestBase {


@BeforeClass
	void CheckFightRandom() throws InterruptedException
	    	{
			logger.info("*********Started TC_031_CheckFightBetweenThreeHeroesInRandomOrder   **********");
			...
			// Posting 2nd Hero
				...
				httpRequest.header("Content-Type", "application/json");
				httpRequest.body(requestParams3.toJSONString());
		...
		void tearDown()
		{
			logger.info("********* Finished TC_031_CheckFightBetweenThreeHeroesInRandomOrder  **********");
		}
