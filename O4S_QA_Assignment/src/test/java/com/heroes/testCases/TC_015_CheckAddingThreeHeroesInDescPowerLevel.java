...
public class TC_015_CheckAddingThreeHeroesInDescPowerLevel   extends TestBase {


@BeforeClass
	void CheckAddinDesc() throws InterruptedException
	    	{
			logger.info("*********Started TC_015_CheckAddingThreeHeroesInDescPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_015_CheckAddingThreeHeroesInDescPowerLevel **********");
		}
