...
public class TC_021_CheckPostforInvaildNotinList extends TestBase {
	
	@BeforeClass
	void CheckInvalid() throws InterruptedException
	{
		logger.info("*********Started TC_021_CheckPostforInvaildNotinList **********");
	...
	void tearDown()
	{
		logger.info("********* Finished TC_021_CheckPostforInvaildNotinList **********");
	}
