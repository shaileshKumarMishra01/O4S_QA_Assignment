...
public class TC_013_CheckAddingTwoHeroesInRandomPowerLevel  extends TestBase {


@BeforeClass
	void CheckRandomAddition() throws InterruptedException
	    	{
			logger.info("*********Started TC_013_CheckAddingTwoHeroesInRandomPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_013_CheckAddingTwoHeroesInRandomPowerLevel **********");
		}
