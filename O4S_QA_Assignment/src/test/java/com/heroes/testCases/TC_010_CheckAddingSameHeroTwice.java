...
public class TC_010_CheckAddingSameHeroTwice extends TestBase {

	@BeforeClass
	void CheckAddSameHero() throws InterruptedException
	{
		logger.info("*********Started TC_010_CheckAddingSameHeroTwice **********");
	...
	void tearDown()
	{
		logger.info("********* Finished TC_010_CheckAddingSameHeroTwice **********");
	}
