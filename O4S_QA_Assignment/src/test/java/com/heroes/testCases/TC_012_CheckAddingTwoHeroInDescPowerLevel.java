...
public class TC_012_CheckAddingTwoHeroInDescPowerLevel   extends TestBase {


@BeforeClass
	void CheckPowerLevel() throws InterruptedException
	    	{
			logger.info("*********Started TC_012_CheckAddingTwoHeroInDescPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_012_CheckAddingTwoHeroInDescPowerLevel **********");
		}
