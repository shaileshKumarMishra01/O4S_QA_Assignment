...
public class TC_024_CheckSuccessMessageAfterAddingTwoHeroes extends TestBase{
	

@BeforeClass
	void CheckMessageforTwo() throws InterruptedException
	    	{
	logger.info("********* Started TC_024_CheckSuccessMessageAfterAddingTwoHeroes **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_024_CheckSuccessMessageAfterAddingTwoHeroes **********");
		}
