...
public class TC_029_CheckFIghtBetweemThreeHeroesInASCPowerLevel   extends TestBase {


@BeforeClass
	void CheckFightAsc() throws InterruptedException
	    	{
			logger.info("*********Started TC_029_CheckFIghtBetweemThreeHeroesInASCPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_029_CheckFIghtBetweemThreeHeroesInASCPowerLevel **********");
		}
