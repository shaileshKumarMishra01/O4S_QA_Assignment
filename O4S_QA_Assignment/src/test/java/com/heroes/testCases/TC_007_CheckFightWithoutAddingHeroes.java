...
public class TC_007_CheckFightWithoutAddingHeroes extends TestBase {
	
	@BeforeClass
	void CheckFightWithoutHeroes() throws InterruptedException
	{
		logger.info("*********Started TC_007_CheckFightWithoutAddingHeroes **********");	
	...
	void tearDown()
	{
		logger.info("********* Finished TC_007_CheckFightWithoutAddingHeroes **********");
	}
