...
public class TC_030_CheckFightBetweemThreeHeroesInDescOrder    extends TestBase {


@BeforeClass
	void CheckFightDesc() throws InterruptedException
	    	{
			logger.info("*********Started TC_030_CheckFightBetweemThreeHeroesInDescOrder  **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_030_CheckFightBetweemThreeHeroesInDescOrder  **********");
		}
