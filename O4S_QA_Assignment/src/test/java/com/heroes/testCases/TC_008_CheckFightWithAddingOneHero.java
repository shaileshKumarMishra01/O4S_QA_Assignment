...
public class TC_008_CheckFightWithAddingOneHero extends TestBase{
	

	@BeforeClass
	void CHeckFightOneHero() throws InterruptedException
	{
		logger.info("*********Started TC_008_CheckFightWithAddingOneHero **********");
	...
	void tearDown()
	{
		logger.info("********* Finished TC_008_CheckFightWithAddingOneHero **********");
	}
