...
public class TC_014_CheckAddingThreeHeroesInAscOrderPowerLevel  extends TestBase {


@BeforeClass
	void Checkddinorder() throws InterruptedException
	    	{
			logger.info("*********Started TC_014_CheckAddingThreeHeroesInAscOrderPowerLevel **********");
		...
		void tearDown()
		{
			logger.info("********* Finished TC_014_CheckAddingThreeHeroesInAscOrderPowerLevel **********");
		}
